...
import {smeCtaContent} from "@/content/sme";

export function SmeCta() {
  return (
    <Cta
      id="sme-cta"
      heading={smeCtaContent.heading}
      subhead={smeCtaContent.subhead}
      background={
        <img
          alt={smeCtaContent.client.alt}
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 size-full object-cover"
          src={smeCtaContent.client.src}
        />
      }
    ...
    >
      <div className="flex w-full flex-col items-center gap-3 sm:w-auto sm:flex-row sm:gap-4">
        <a
          href={smeCtaContent.primaryHref}
        ...
        >
          {smeCtaContent.primaryCta}
        </a>

        <a
          href={smeCtaContent.secondaryHref}
